import * as fpvm32 from "../src/fpv32"
import {stopwatch} from "./stopwatch"

const iterations = 100000000
const cachesize  = 64

let context = new fpvm32.Context(cachesize)
...
stopwatch("normalize_v2()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v2(1, 1)
    let c = context.normalize_v2(a)
  }
})
stopwatch("normalize_v3()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v3(1, 1, 1)
    let c = context.normalize_v3(a)
  }
})
stopwatch("normalize_v4()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v4(1, 1, 1, 1)
    let c = context.normalize_v4(a)
  }
})
stopwatch("mag_v2()", () => {
  for(let i = 0; i < iterations; i++) {
...
stopwatch("distance_f32_f32()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.f32(1)
    let b = context.f32(1)
    let c = context.distance_f32_f32(a, b)
  }
})
stopwatch("distance_v2_v2()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v2(1, 1)
    let b = context.v2(1, 1)
    let c = context.distance_v2_v2(a, b)
  }
})
stopwatch("distance_v3_v3()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v3(1, 1, 1)
    let b = context.v3(1, 1, 1)
    let c = context.distance_v3_v3(a, b)
  }
})
stopwatch("distance_v4_v4()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v4(1, 1, 1, 1)
    let b = context.v4(1, 1, 1, 1)
    let c = context.distance_v4_v4(a, b)
  }
})
stopwatch("distancesq_f32_f32()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.f32(1)
    let b = context.f32(1)
    let c = context.distancesq_f32_f32(a, b)
  }
})
stopwatch("distancesq_v2_v2()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v2(1, 1)
    let b = context.v2(1, 1)
    let c = context.distancesq_v2_v2(a, b)
  }
})
stopwatch("distancesq_v3_v3()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v3(1, 1, 1)
    let b = context.v3(1, 1, 1)
    let c = context.distancesq_v3_v3(a, b)
  }
})
stopwatch("distancesq_v4_v4()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.v4(1, 1, 1, 1)
    let b = context.v4(1, 1, 1, 1)
    let c = context.distancesq_v4_v4(a, b)
  }
})
...
stopwatch("m4_rotation_x()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.f32(0)
    let c = context.m4_rotation_x(a)  
  }
})
stopwatch("m4_rotation_y()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.f32(0)
    let c = context.m4_rotation_y(a)  
  }
})
stopwatch("m4_rotation_z()", () => {
  for(let i = 0; i < iterations; i++) {
    let a = context.f32(0)
    let c = context.m4_rotation_z(a)  
  }
})
// stopwatch("m4_lookat()", () => {
//   for(let i = 0; i < iterations; i++) {
